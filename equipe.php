...
<head>
  ...
  <link rel="stylesheet" href="src/css/main-equipe.css">
  ...
  <meta charset="utf-8">
  <title>EHPAD André Blanc - Notre Équipe</title>
  <meta name="description" content="Découvrez l'équipe de l'EHPAD André Blanc." />
  <link rel="shortcut icon" href="src/img/logo-ehpad.ico" media="none" onload="if(media!='all')media='all'"/>
</head>
<body>
  <?php
    include 'src/html/header.php';
    include 'src/html/main-equipe.php';
    include 'src/html/footer.php';
    include 'src/html/subfooter.php';
  ?>
  <script type="text/javascript" async>
    document.getElementsByClassName("navElements")[2].style.fontStyle = "italic"
    document.getElementsByClassName("navElements")[2].style.borderColor = "#000";
  </script>
</body>
</html>
