...
<head>
  ...
  <link rel="stylesheet" href="src/css/main-ehpad.css">
  ...
  <meta name="description" content="Découvrez le fonctionnement global de l'EHPAD André Blanc, résidence sous la responsabilité de M. Devarieux." />
  <link rel="shortcut icon" href="src/img/logo-ehpad.ico" media="none" onload="if(media!='all')media='all'"/>
</head>
<body>
  <?php
    include 'src/html/header.php';
    include 'src/html/main-ehpad.php';
    include 'src/html/footer.php';
    include 'src/html/subfooter.php';
  ?>
</body>
<script type="text/javascript" async>
    document.getElementsByClassName("navElements")[1].style.fontStyle = "italic"
    document.getElementsByClassName("navElements")[1].style.borderColor = "#000";
  </script>
</html>
