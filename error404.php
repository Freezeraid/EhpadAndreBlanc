...
<head>
  ...
  <link rel="stylesheet" href="src/css/main-error404.css">
  ...
  <meta name="description" content="La page que vous souhaitez visiter n'existe pas." />
...
<body>
  <?php
    ...
    include 'src/html/main-error404.php';
